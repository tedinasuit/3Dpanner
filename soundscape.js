function createPlayerPlusPanner(url, positionX, positionY, positionZ) {
  ...
  createPlayerPlusPanner("sounds/Bird Chirping   Sound Effect.mp3", 2, 0, 0);
  createPlayerPlusPanner("sounds/Chimes   Free Sound Effects HD with download link   YouTube.mp3", 0, 0, 2);
  createPlayerPlusPanner("sounds/Tibetan bell sound every minute for ten minutes.mp3", -2, 0, 2);
